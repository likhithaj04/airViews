...
module.exports.rendershowListing=async(req,res)=>{
    ...
    .populate("owner");
    if(!listing){
    req.flash("error","listing dosent exists");
    res.redirect('/listing');
    }
     res.render("listings/show.ejs",{listing});
}

module.exports.renderPostListing=async(req,res,next)=>{
...
module.exports.renderUpdateListing=async(req,res)=>{
       let {id}=req.params;
       let listing=await Listing.findByIdAndUpdate(id,{...req.body.listing})//javascript object  function
